...
# docker build -t last_war_alliance_manager .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name last_war_alliance_manager last_war_alliance_manager
