...
RSpec.feature 'Alliance Players Management', type: :feature do
  ...
  describe 'players management' do
    ...
    it 'shows players sorted alphabetically by username, case-insensitively' do
      create(:player, alliance: alliance, username: 'charlie')
      create(:player, alliance: alliance, username: 'Bravo')
